...
<script type="text/javascript" src="__PUBLIC__/index/js/register.js"></script>
</head>
<body>

  <div class="content">
         <div class="cen_cnt login">
           <a href="<?php echo U('/Admin/regedit');?>">注册</a><a href="<?php echo U('/Admin/login');?>">登录</a>
         </div>
         ...
         <div class="content navbg">
             <!--<div class="cen_cnt">
               <div class="nav">
                <a class="active" href="<?php echo U('/Index');?>">首页</a><a>手机网赚</a><a>任务网赚</a><a>游戏网赚</a><a>挂机网赚</a><a>签到网赚</a>
               </div>
               <div class="tolearn">
                <a>网赚学堂</a>
               </div>
