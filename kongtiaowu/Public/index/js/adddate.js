...
var date = new Date(); 
var by = date.getFullYear()-5; //最小值 → 5 年前 
var ey = date.getFullYear()+1000; //最大值 →1000年后 
...
this.colors = { 
"cur_word"      : "#FFFFFF", //当前日期文字颜色 
"cur_bg"        : "#00FF00", //当前日期单元格背影色 
...
mvAry[mvAry.length] = '    <table width="100%" border="0" cellpadding="0" cellspacing="1" style="font-size:12px;border-bottom:1px solid #CCC">'; 
